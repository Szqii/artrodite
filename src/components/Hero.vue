<template>
    <div class="row mx-auto justify-content-between align-items-start px-2 px-lg-100 h-screen overflow-hidden">
        <div class="col-lg-3 d-none d-lg-inline-block ">
            <div class="title-text" data-aos="fade-up" style="cursor: default;">artrodite</div>
        </div>
        <div class="row col-12 col-lg-9 mx-auto">
            <div class="col-12 col-md-4 px-4 d-flex flex-column justify-content-between">
                <span class="mb-0 mb-md-5 text-artrodite-gray" data-aos="fade-up" data-aos-delay="100">Artrodite <span
                ...
                <video ref="video1" :src="videoUrl1" v-show="allVideosLoaded" class="rounded d-none d-md-block mt-0 mt-md-5" data-aos="flip-left" data-aos-delay="100"
                    autoplay muted loop></video>
            </div>
            <div class="col-12 col-md-4 px-4 d-flex flex-column justify-content-between mt-4 mt-md-0">
                <span class="mb-0 mb-md-5 text-artrodite-gray" data-aos="fade-up" data-aos-delay="200">
                ...
                <video ref="video2" :src="videoUrl2" v-show="allVideosLoaded" class="rounded d-none d-md-block mt-0 mt-md-5" data-aos="flip-left" data-aos-delay="200"
                    autoplay muted loop></video>

            </div>
            <div class="col-12 col-md-4 px-4 d-flex flex-column justify-content-between my-4 my-md-0">
                <router-link class="mb-0 mb-md-5 makeItBlack" data-aos="fade-up" data-aos-delay="300" to="/studio"> <span
                ...
                <video ref="video3" :src="videoUrl3" v-show="allVideosLoaded" class="rounded d-none d-md-block mt-0 mt-md-5" data-aos="flip-left" data-aos-delay="300"
                    autoplay muted loop></video>
            </div>
